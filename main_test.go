...
func TestErrors(t *testing.T) {
	...
	if runtime.GOOS != "windows" { // unix
		...
		result.AssertContains("ERROR: The command has failed with exit code exit status 1")
	}
	...
	if runtime.GOOS == "windows" {
		...
		result.AssertContains(
			"not found",
			"ERROR: The command has failed with exit code exit status",
		)
	}

	result = tester("error-proj-1", ":missing-env-var")
	result.AssertContains("ERROR: The command has failed with exit code exit")
	...
	result.AssertContains("ERROR: Project `pre` command failed: The command has failed with exit code exit status 1")

	result = tester("error-proj-5:test")
	result.AssertContains("ERROR: Command `pre` command failed: The command has failed with exit code exit status 1")

	result = tester("error-proj-6:test")
	result.AssertContains("ERROR: Command `post` command failed: The command has failed with exit code exit status 1")

	result = tester("error-proj-7:test")
	result.AssertContains("ERROR: Project `post` command failed: The command has failed with exit code exit status 1")
	...
	if runtime.GOOS != "windows" { // unix
		...
		result.AssertSequentialOrder(
			...
			"ERROR: The command has failed with exit code exit",
		)
	}
	...
	result.AssertContains("ERROR: Fail during execution of after command(s): The command has failed with exit code exit status 1")
	...
	result.AssertContains(
		...
		"ERROR: The command has failed with exit code exit status 1",
	)
	result.AssertNotContains("Fail during execution of after command(s)")

	result = tester("watch-mode-error-6:test-1")
	result.AssertContains("ERROR: Fail during execution of after command(s) in watch mode: The command has failed with exit code exit status 1")
	...
	result.AssertContains(
		...
		"ERROR: Fail during execution of after command(s) in watch mode: The command has failed with exit code exit status 1",
	)
	...
	result.AssertContains("error-proj-12:test-1 ⟫ ERROR: Fail during execution of after command(s): The command has failed with exit code exit status 1")

	result = tester("-d", "runner-error-8")
	result.AssertContains("error-proj-13:test ⟫ ERROR: Fail during execution of after command(s): The command has failed with exit code exit status 1")
...
func TestWatchModeExecution(t *testing.T) {
	...
	result.AssertOccurrences("\nExecuting `node continuous.js`", 3)
	result.AssertOccurrences("File change detected. Stopping running command...", 2)
...
func TestRunnerExecution(t *testing.T) {
	...
	result.AssertContains(
		...
		"proj-50:test ⟫ ERROR: The command has failed with exit code exit status 1",
	...
	if runtime.GOOS == "windows" {
		result = testerWithTTL(5*time.Second, "runner-8-win")
		result.AssertContains(
			"1 runner-8-win ⟫ Executing `navi runner-4`",
			"2 runner-8-win ⟫ Executing `navi runner-5`",
			"2 runner-8-win ⟫ proj-33:env-vars-2 ⟫ Executing `python3 env_vars_pre.py`",
			"2 runner-8-win ⟫ proj-2:test-1 ⟫ Executing `npm run main`",
			"1 runner-8-win ⟫ 1 proj-2:test-1 ⟫ Executing `npm run main`",
			"1 runner-8-win ⟫ 2 proj-2:test-1 ⟫ Executing `npm run main`",
			"1 runner-8-win ⟫ proj-33:test ⟫ Executing `python3 main.py`",
			"1 runner-8-win ⟫ 1 proj-2:test-1 ⟫ running main.js",
			"1 runner-8-win ⟫ 2 proj-2:test-1 ⟫ running main.js",
			"1 runner-8-win ⟫ proj-33:test ⟫ running main.py",
			"2 runner-8-win ⟫ proj-33:env-vars-2 ⟫ pre ENV_VAR1: \"|@%&*\"",
			"2 runner-8-win ⟫ proj-33:env-vars-2 ⟫ post ENV_VAR1: \"|@%&*\"",
		)
	} else { // unix
	...
	result.AssertOccurrences("1 watch-mode:error ⟫ ERROR: The command has failed with exit code exit status 1", 4)
	...
	result.AssertOccurrences("proj-50:test ⟫ ERROR: The command has failed with exit code exit status 1", 3)
	...
	result.AssertContains(
		...
		"proj-2:timeout-2 ⟫ Executing `npm run timeout-2`",
		"other[serial]format:command[dependent]format ⟫ ERROR: The command has failed with exit code exit status 1",
		"proj-2:timeout-1 ⟫ Command(s) completed successfully",
		"proj-2:timeout-2 ⟫ Command(s) completed successfully",
	...
	result.AssertContains(
		...
		"proj-2 ⟫ Executing `npm run timeout-3`",
		"proj-2:timeout-2 ⟫ Executing `npm run timeout-2`",
		"proj-2:exit ⟫ ERROR: The command has failed with exit code exit status 1",
		"proj-2:timeout-2 ⟫ Command(s) completed successfully",
		"proj-2 ⟫ Command(s) completed successfully",
	)
	...
	result = testerWithTTL(8*time.Second, "runner-67")
	result.AssertNotContains("other-1")
	result.AssertContains(
...
func TestProjectExecution(t *testing.T) {
	...
	if runtime.GOOS != "windows" { // unix
		result = tester("other-2")
		result.AssertSequentialOrder(
			"Executing `cd node`",
			"\nExecuting `echo \"cwd => "+os.Getenv("PWD")+"\"`",
			"cwd => "+os.Getenv("PWD"),
	...
	if runtime.GOOS != "windows" { // unix
		result = tester("other-4")
		result.AssertSequentialOrder(
			"Executing `cd node && echo \"cwd => "+os.Getenv("PWD")+"\" && node main.js`",
			"cwd => "+os.Getenv("PWD"),
			"\nrunning main.js",
			"\nCommand(s) completed successfully",
		)
	} else { // windows
		result = tester("other-5")
		result.AssertSequentialOrder(
			"Executing `cd node && echo \"cwd => %CD%\" && node main.js`",
			"cwd => "+filepath.Join(fixturesDir),
			"\nrunning main.js",
			"\nCommand(s) completed successfully",
		)
	...
	result.AssertOccurrences("\nExecuting `node args.js`", 1)
	result.AssertOccurrences("\nExecuting `node args.js node --version`", 1)
	...
	if runtime.GOOS == "windows" {
		...
		result.AssertSequentialOrder(
			"Path",
			"----",
			filepath.Join(fixturesDir, "node"),
		)

		result = tester("proj-2:default-shell-win-1")
		result.AssertContains(
			"Executing `echo \"cwd => $PWD\"`",
			"cwd => $PWD",
		)

		result = tester("proj-2:default-shell-win-2")
		result.AssertContains(
			"Executing `echo \"cwd => %CD%\"`",
			"cwd => "+filepath.Join(fixturesDir, "node"),
		)
	} else { // unix
		...
		result = tester("proj-2:cwd-default-shell-unix")
	...
	if runtime.GOOS == "windows" {
		...
		result.AssertOccurrences("Running main command...", 1)
		result.AssertSequentialOrder(
			"Running main command...",
...
func TestCLI(t *testing.T) {
	...
	result.AssertSequentialOrder(
		"                             Navi CLI",
		"-------------------------------------------------------------------",
		"Filter: error-proj-    [1 of 16] ¦ Definition:",
		"                                 ¦",
	...
	result.AssertSequentialOrder(
		"                    Navi CLI",
		"--------------------------------------------------",
		"Filter:  proj [7 of 14] ¦ Definition:",
		"                        ¦",
		"error-proj-8:...Project ¦ proj-20:",
		"proj-15:shel....Project ¦   dir: node",
		"proj-16:shel....Project ¦   shell: powershell",
		"proj-17:shel....Project ¦   cmds:",
		"proj-18:shel....Project ¦     ...",
		"proj-19:shel....Project ¦     shell-test:",
		"proj-20:shell...Project ¦       shell: sh",
		"          ↓             ¦             ↓",
		"--------------------------------------------------",
	...
	result.AssertSequentialOrder(
		"                                   Navi CLI",
		"--------------------------------------------------------------------------------",
		"Filter: shell proj           [8 of 14] ¦ Definition:",
		"                  ↑                    ¦                    ↑",
		"proj-15:shell-test             Project ¦   dir: node",
		"proj-16:shell-test             Project ¦   shell: cmd",
		"proj-17:shell-test             Project ¦   cmds:",
		"proj-18:shell-test             Project ¦     ...",
		"proj-19:shell-test             Project ¦     shell-test:",
		"proj-20:shell-test             Project ¦       shell: bash",
		"proj-21:shell-test             Project ¦       run: echo \"main path \\$PWD\"",
		"                  ↓                    ¦",
		"--------------------------------------------------------------------------------",
